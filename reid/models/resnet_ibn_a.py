...
model_urls = {
    'ibn_resnet50a': '/data/ustc/wbq/ECN-moment/logs/pretrained/resnet50_ibn_a.pth',
    'ibn_resnet101a': '/data/ustc/wbq/ECN-moment/logs/pretrained/resnet101_ibn_a.pth.tar',
}
