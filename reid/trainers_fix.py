...
class Trainer(object):
    ...
    def train(self, epoch, data_loader, target_train_loader, optimizer, print_freq=1):
        ...
        for i, inputs in enumerate(data_loader):
            ...
            outputs_ema = self.model_ema(inputs_target, 'tgt_feat') ########new add

            loss_un = self.model_inv(outputs,outputs_ema, index_target, epoch=epoch)
            ...
            self._update_ema_variables(self.model, self.model_ema, self.alpha)#######################update model_ema
