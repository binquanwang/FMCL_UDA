...
def main(args):
   ...
   # model_ema.module.classifier.weight.data.copy_(model.module.classifier.weight.data)
    ...
    # Trainer
    trainer = Trainer(model,model_ema, model_inv, lmd=args.lmd)   #####new add
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        evaluator.evaluate(query_loader_2, gallery_loader_2, dataset_2.query,
                       dataset_2.gallery, args.output_feature)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--init-1', type=str, default='/data/ustc/wbq/ECN-contrast/logs/pretrain_duke2market-ECN/pre_checkpoint_save.pth.tar', metavar='PATH')
